...
namespace MigrationExecutionAPI.Migrations
{
    ...
    [Migration("20260919041843_AddNugetWarningsAndVulnerabilities")]
    partial class AddNugetWarningsAndVulnerabilities
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MigrationExecutionAPI.Models.Organization", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 9, 19, 4, 18, 41, 780, DateTimeKind.Utc).AddTicks(2353),
                            Name = "Global Corp"
                        });
                });
