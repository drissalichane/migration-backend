...
namespace MigrationExecutionAPI.Migrations
{
    ...
    [Migration("20260926000909_GitHubPersonalAccessToken")]
    partial class GitHubPersonalAccessToken
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MigrationExecutionAPI.Models.LlmUsageLog", b =>
                {
                    ...
                    b.Property<string>("FinishReasons")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("MigrationExecutionAPI.Models.MigrationJob", b =>
                {
                    ...
                    b.Property<string>("N8nExecutionIdPhase1")
                        .HasColumnType("TEXT");

                    b.Property<string>("N8nExecutionIdPhase2")
                        .HasColumnType("TEXT");

                    b.Property<string>("NugetVulnerabilities")
                        .HasColumnType("TEXT");

                    b.Property<string>("NugetWarnings")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("MigrationExecutionAPI.Models.Organization", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 9, 26, 0, 9, 7, 199, DateTimeKind.Utc).AddTicks(2688),
                            Name = "Global Corp"
                        });
                });
            ...
            modelBuilder.Entity("MigrationExecutionAPI.Models.User", b =>
                {
                    ...
                    b.Property<string>("GitHubPatLogin")
                        .HasColumnType("TEXT");
