...
const createMockExecuteFunction = (nodeParameters, typeVersion = exports.node.typeVersion) => {
    const mockNode = typeVersion === exports.node.typeVersion ? exports.node : { ...exports.node, typeVersion };
