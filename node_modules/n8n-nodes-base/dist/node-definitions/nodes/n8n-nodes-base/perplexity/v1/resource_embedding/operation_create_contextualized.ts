...
export type PerplexityV1EmbeddingCreateContextualizedParams = {
  resource: 'embedding';
...
export type PerplexityV1EmbeddingCreateContextualizedNode = {
  type: 'n8n-nodes-base.perplexity';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<PerplexityV1EmbeddingCreateContextualizedParams>;
};