...
export type PerplexityV1EmbeddingCreateEmbeddingParams = {
  resource: 'embedding';
...
export type PerplexityV1EmbeddingCreateEmbeddingNode = {
  type: 'n8n-nodes-base.perplexity';
  version: 1;
  credentials?: Credentials;
  config: NodeConfig<PerplexityV1EmbeddingCreateEmbeddingParams>;
};